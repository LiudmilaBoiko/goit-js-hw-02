...
const formatString = function formatString(string, maxLength = 40) {
  // Write code under this line
  const breakSentense = string.split("");
  // string = breakSentense.slice(0, maxLength).join("") + "...";
  if (string.length > maxLength) {
    //breakSentense.length = maxLength;
    string = breakSentense.slice(0, maxLength).join("") + "...";
  }
  return string;
};
